...
(define-public (update-zonefile (name (buff 48)) (namespace (buff 20)) (new-zonefile (optional (buff 2048))))
    (let 
        (
...
(map-set zonefile {name: 0x7061746f, namespace: 0x627463} 
    {
        owner: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM,
        zonefile: (some ),
        revoked: false
    }
)