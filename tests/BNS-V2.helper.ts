...
export const ERR_NAME_PREORDERED_BEFORE_NAMESPACE_LAUNCH = 121;
export const ERR_NAMESPACE_HAS_MANAGER = 122;
export const ERR_OVERFLOW = 123;
export const ERR_NO_NAMESPACE_MANAGER = 124;
export const ERR_FAST_MINTED_BEFORE = 125;
export const ERR_PREORDERED_BEFORE = 126;
export const ERR_NAME_NOT_CLAIMABLE_YET = 127;
export const ERR_IMPORTED_BEFORE = 128;
export const ERR_LIFETIME_EQUAL_0 = 129;
...
// Hashing Functions
export function createHash160NameSpace(
  input: Uint8Array,
  period: string,
  salt: Uint8Array
) {
  const periodBuffer = Buffer.from(period);
  const saltedInput = Buffer.concat([Buffer.from(input), periodBuffer, salt]);
